...
export interface PlanConfig {
  ...
  promptsPerKeyword: number; // How many prompt variations per keyword for AI Monitor
  whiteLabel: boolean;
  reports: boolean;
...
export const PLANS: Record<PlanId, PlanConfig> = {
  solo: {
    ...
    maxAuditsPerMonth: 1,
    monitorFrequency: "weekly",
    promptsPerKeyword: 3, // Lighter scanning for solo users
    whiteLabel: false,
    reports: true,
    support: "email",
    popular: false,
  ...
  agency: {
    id: "agency",
    name: "Agency Light",
    tagline: "AI visibility at scale for growing agencies.",
    priceMonthly: 497,
    priceAnnualMonthly: 397,
    maxClients: 15,
